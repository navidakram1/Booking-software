        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
                <form action="{{ route('contact.send') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        <button type="submit" 
                                class="w-full px-6 py-3 bg-gradient-to-r from-pink-500 to-purple-600 text-white font-semibold rounded-lg hover:from-pink-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transform transition-all duration-200">
                            Send Message
                        </button>
                    </div>
                </form>
