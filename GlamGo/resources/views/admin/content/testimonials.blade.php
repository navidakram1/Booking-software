                    ...
                    <div class="flex items-center mb-4">
                        <div class="flex-shrink-0">
                            <div class="w-12 h-12 rounded-full bg-pink-100 flex items-center justify-center">
                                <span class="text-pink-600 text-lg font-semibold">{{ substr(json_decode($testimonial->customer_details, true)['name'] ?? '', 0, 1) }}</span>
                            </div>
                        </div>
                        <div class="ml-3">
                            <h3 class="font-semibold text-gray-800">{{ json_decode($testimonial->customer_details, true)['name'] ?? 'N/A' }}</h3>
                            <p class="text-sm text-gray-500">{{ json_decode($testimonial->customer_details, true)['email'] ?? 'N/A' }}</p>
                        </div>
                    </div>
