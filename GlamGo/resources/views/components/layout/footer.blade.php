    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="mb-12">
            <div class="max-w-xl mx-auto text-center">
                ...
                <p class="text-gray-600 mb-6">Subscribe to our newsletter for exclusive offers and beauty tips.</p>
                <form class="flex space-x-2">
                    <input type="email" placeholder="Enter your email" class="flex-1 px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                    <button type="submit" class="px-6 py-2 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-lg hover:shadow-lg transition-all duration-300">
                        Subscribe
                    </button>
                </form>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="space-y-4">
                ...
                <p class="text-gray-600">Your premier destination for professional beauty services.</p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-600 hover:text-pink-500 transition-colors">Spa & Massage</a></li>
                </ul>
            </div>

            <!-- Contact Info -->
            <div>
                <h4 class="text-gray-900 font-semibold mb-4">Contact Us</h4>
                <ul class="space-y-2">
        ...
        <div class="mt-12 pt-8 border-t border-gray-200">
            <p class="text-center text-gray-600">&copy; {{ date('Y') }} GlamGo. All rights reserved.</p>
        </div>
    </div>
</footer> 