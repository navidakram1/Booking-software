@props(['social_links' => [], 'company_info' => []])
    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div class="space-y-8 xl:col-span-1">
                <img class="h-10" src="{{ asset('images/logo-white.png') }}" alt="GlamGo Logo">
                <p class="text-gray-400 text-base">
                    {{ $company_info['description'] ?? 'Making beauty services accessible to everyone, anywhere, anytime.' }}
                </p>
                <div class="flex space-x-6">
                    @foreach($social_links as $platform => $url)
                        <a href="{{ $url }}" class="text-gray-400 hover:text-gray-300" target="_blank" rel="noopener noreferrer">
                ...
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    <div>
                        ...
                        <ul class="mt-4 space-y-4">
                            <li>
                                <a href="{{ route('services.hair') }}" class="text-base text-gray-300 hover:text-white">
                                    Hair Styling
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('services.makeup') }}" class="text-base text-gray-300 hover:text-white">
                                    Makeup
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('services.nails') }}" class="text-base text-gray-300 hover:text-white">
                                    Nail Care
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('services.spa') }}" class="text-base text-gray-300 hover:text-white">
                                    Spa & Wellness
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="mt-12 md:mt-0">
                        ...
                        <ul class="mt-4 space-y-4">
                            ...
                            <li>
                                <a href="{{ route('careers') }}" class="text-base text-gray-300 hover:text-white">
                                    Careers
                                </a>
                            </li>
                            <li>
        ...
        <div class="mt-12 border-t border-gray-700 pt-8">
            <p class="text-base text-gray-400 xl:text-center">
                &copy; {{ date('Y') }} GlamGo. All rights reserved.
            </p>
        </div>
    </div>
</footer>
